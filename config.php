...
<nav class="navegacao navbar navbar-expand-md cornav fixed-top">
  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item ">
        <a class="nav-link  lista" href="user.php"><i class="fas fa-landmark"></i> Início</a>
      </li>
      <li class="nav-item">
        <a class="nav-link ativo" href="config.php"><i class="fas fa-brain"></i> Configurações</a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link lista" href="resp.php"></li><i class="fas fa-check"></i> Respostas</a>
      </li>
        </div>
      </li>
    </ul>
    <form action="sair.php">
    <button class="btn botao" type="submit"><i class="fas fa-power-off"></i> Sair</button>  
  </form>
  </div>
</nav>
...
<div class="container">
  ...
  <input type="text" class="form-control" id="usr" placeholder="Nome" name="nome">
      </div>
      <div class="form-group">
      ...
      <div class="input-group mb-3">
		...
		<div class="col-md-6">
    		<form action="deletar.php">
    			<button class="btn botao" type="submit">Deletar usuário</button>  
    		</form>
    	</div>
    	</div>
