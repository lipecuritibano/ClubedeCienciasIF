...
<div class="container">
  <form method='post' action='excluirf.php'>
<div class='input-group mb-3'>
        <input type='number' class='form-control' placeholder='Excluir publicação imprópria' name='cod'>
...
<div class='input-group mb-3'>
        <input type='text' class='form-control' placeholder='O que você gostaria de dizer?' name='publicacao'>
        <div class='input-group-append'>
