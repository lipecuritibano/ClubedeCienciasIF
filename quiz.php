...
<nav class="navegacao navbar navbar-expand-md cornav fixed-top">
  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link ativo" href="quiz.php"><i class="fas fa-tasks"></i></i> Quiz</a>
      </li>
      <li class="nav-item">
...
$sql = "SELECT * FROM pergunta ORDER BY cod DESC";
...
<div class='input-group mb-3'>
        <input type='text' class='form-control' placeholder='Resposta' name='resposta'>
