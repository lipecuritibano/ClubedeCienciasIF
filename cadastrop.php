...
<nav class="navegacao navbar navbar-expand-md cornav fixed-top">
  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link ativo" href="cadastrop.php"></li><i class="fas fa-question"></i> Cadastro de Perguntas</a>
      </li>
      <li class="nav-item">
...
<div id="demo" class="carousel slide carrosel" data-ride="carousel">
    ...
    <li data-target="#demo" data-slide-to="1"></li>
      ...
      <div class="carousel-inner">
        ...
        <h1 class="corcar">Olá Área de administrador</h1>
...
<div class="container">
	<form method="post" action="inserirp.php">
      <h6>Publicar pergunta</h6>
      <div class="form-group">
  <input type="text" class="form-control" id="usr" placeholder="Título" name="titulo" required>
      </div>
      <div class="form-group">
        <textarea class="form-control" id="usr" placeholder="perguntas" name="pergunta" rows=10 cols=30 required></textarea> 
      </div>
      <div class="form-group">
        <input type="date" class="form-control" name="data" required>
      </div>
          <button class="btn botao" type="submit">Cadastrar pergunta(s)</button>  
        </div>
      </div>
      </form>
</div>
<div class="container">
	<form method="post" action="excluirp.php">
      <h6>Excluir pergunta</h6>
      <div class="form-group">
  <input type="text" class="form-control" id="usr" placeholder="Código da pergunta" name="codig">
      </div>
      <button class="btn botao" type="submit">Excluir pergunta</button>
  </form>
</div>
</main>
