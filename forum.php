...
<nav class="navegacao navbar navbar-expand-md cornav fixed-top">
  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
   <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link ativo" href="forum.php"><i class="fas fa-archway"></i> Fórum</a>
      </li>
      <li class="nav-item">
...
<div class="container">
  <form method='post' action='inserirf.php'>
<div class='input-group mb-3'>
        <input type='text' class='form-control' placeholder='O que você gostaria de dizer?' name='publicacao' required>
        <div class='input-group-append'>
          <button class='btn botao' type='submit'>publicar</button>  
        </div>
      </div>
    </form>
    <?
